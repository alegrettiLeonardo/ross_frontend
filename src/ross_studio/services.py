...
class RossCapabilityRegistry:
    ...
    _CAPABILITIES = (
        ...
        Capability(BearingGroup.THD, "SqueezeFilmDamper", "Squeeze Film Damper", AdapterStatus.VALIDATED, "Native ROSS 2.3 analytical hydrodynamic SFD workflow (HD, not thermal THD): engineering input, calculate, solved K/C preview, BearingElement apply, flexible n_link, strict rotor and modal. Unsupported native thermal fields remain explicitly unavailable."),

...
class StaticModalNativeFigureCatalog:
    """Post-process retained ROSS result objects without re-running an analysis."""
...
__all__ = ["NativeStaticModalFigureSpec", "STATIC_FIGURES", "StaticModalNativeFigureCatalog"]
